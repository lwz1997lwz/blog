...
<body>
	<div class="header">
		...
		<h1 id="big-title">${article.name}</h1>
		<h4 id="article-time">${article.title}</h4>
	</div>
...
<script>
	$(document).ready(function() {
		$(".header").css("background-image", "url(/upload/${article.cover})");
