...
.block2 {
	margin-bottom: 60px;
	border-radius: 6px;
	-webkit-box-shadow: 0 16px 38px -12px rgba(0, 0, 0, 0.56), 0 4px 25px 0
		rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);
	-moz-box-shadow: 0 16px 38px -12px rgba(0, 0, 0, 0.56), 0 4px 25px 0
		rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);
	box-shadow: 0 16px 38px -12px rgba(0, 0, 0, 0.56), 0 4px 25px 0
		rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);
}
...
.search {
	...
	-moz-box-shadow: none;
	box-shadow: none;
	background-image: -webkit-gradient(linear, left top, left bottom, from(#9c27b0),
		to(#9c27b0)),
...
.is-focused .search {
	background-image: -webkit-gradient(linear, left top, left bottom, from(#06999e),
		to(#06999e)),
		-webkit-gradient(linear, left top, left bottom, from(#d2d2d2),
		to(#d2d2d2));
	background-image: -webkit-linear-gradient(#06999e, #06999e),
		-webkit-linear-gradient(#d2d2d2, #d2d2d2);
	background-image: linear-gradient(#06999e, #06999e),
		linear-gradient(#d2d2d2, #d2d2d2);
	outline: none;
...
.page .active a {
	...
	border-color: #06999e;
	-webkit-box-shadow: 0 14px 26px -12pxrgba(6, 153, 158, 0.42), 0 4px 23px
		0 rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(6, 153, 158, 0.2);
	box-shadow: 0 14px 26px -12px rgba(6, 153, 158, 0.42), 0 4px 23px 0
		rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(6, 153, 158, 0.2);
	color: #fff;
}
...
<body>
	<div class="header">
		...
		<input type="hidden" id="typeId" value="${typeInfo.id}">
	</div>
	...
	<div id="content">
		<div class="block" style="border-radius: 6px 6px 0 0;">
			<div class="grid-1-2-1">
				<div></div>
				<div id="main-content"
					style="min-width: 650px;margin-top: 100px;margin-bottom: 40px;">
						...
						<div class="block block2">
							<div class="grid-5-7" style="height: 250px;">
								...
								<div class="main-15">
									<h4>
										<a
											href="/blog/portal/articleByTypelist.action?typeId=${entity.typeId}">${entity.name}</a>
									</h4>
									<h2>
									...
									<div style="text-align: right"><a
										href="/blog/portal/articleContent.action?articleId=${entity.id}"
										style="color:green; font-weight: bold; font-size:15px;">阅读更多…</a>
									</div>
									<div class="day">2018-02-20</div>
								</div>
							</div>
						</div>
					</c:forEach>
...
<script>
	...
	function search(pageNum){
			...
			window.location.href="articleByTypelist.action?pageNum="+pageNum
			+"&typeId="+typeId;
		}
</script>
</html>
