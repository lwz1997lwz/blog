...
<body>
	...
	<div style="width: 100%;height: 100px;display: flex;">
		<div style="width: 1200px;margin: 20px auto;">
			<a href="#"> <img src="blog/static/javaex/pc/images/logo.png" />
			</a>
		</div>
	</div>
	<!--中间主体信息-->
		...
		<form id="login">
			<div class="login-form">
				...
				<div class="login-item">
					<input type="text" class="login-text" id="username" name="username"
						data-type="必填" placeholder="用户名" />
				</div>
				<!--密码-->
				<div class="login-item">
...
<!-- 使用了jQuery中的ajax 表示选取id为submit的按钮 并为其添加事件（将login表单中的值序列化提交） 使用json返回 -->
<script>
			...
			$.ajax({
				...
				success : function(rtn) {
				    if(rtn.code=="000000")
				        ...
				        addErrorMsg("username", rtn.message);    
				}
			})
		}
	}
